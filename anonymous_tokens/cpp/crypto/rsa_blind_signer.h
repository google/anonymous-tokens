...
#ifndef ANONYMOUS_TOKENS_CPP_CRYPTO_RSA_BLIND_SIGNER_H_
#define ANONYMOUS_TOKENS_CPP_CRYPTO_RSA_BLIND_SIGNER_H_
...
#include "anonymous_tokens/cpp/crypto/blind_signer.h"
